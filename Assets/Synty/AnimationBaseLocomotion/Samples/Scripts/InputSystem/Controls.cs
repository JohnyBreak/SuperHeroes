...
public partial class @Controls: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""WallCheck"",
                    ""type"": ""Button"",
                    ""id"": ""40d219dd-cf13-435d-aa6d-4a710445f9ba"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                ...
                },
                {
                    ""name"": ""Web"",
                    ""type"": ""Button"",
                    ""id"": ""0d34af38-428b-4876-a6c1-1ffbd7923a65"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""07a7055b-0f8c-4d87-988b-d5d6de9643c7"",
                    ""path"": ""<Keyboard>/f"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Keyboard and Mouse"",
                ...
                {
                    ""name"": """",
                    ""id"": ""440da16c-5082-470c-8d73-6da2f59fb28b"",
                ...
                {
                    ""name"": """",
                    ""id"": ""3f159ac5-1926-4b91-b6e7-351833d9e379"",
    ...
    ""controlSchemes"": [
        ...
        m_Player_WallCheck = m_Player.FindAction("WallCheck", throwIfNotFound: true);
        m_Player_Move = m_Player.FindAction("Move", throwIfNotFound: true);
        m_Player_Look = m_Player.FindAction("Look", throwIfNotFound: true);
        m_Player_Sprint = m_Player.FindAction("Sprint", throwIfNotFound: true);
        m_Player_ToggleWalk = m_Player.FindAction("ToggleWalk", throwIfNotFound: true);
        m_Player_Aim = m_Player.FindAction("Aim", throwIfNotFound: true);
        m_Player_Web = m_Player.FindAction("Web", throwIfNotFound: true);
    ...
    private readonly InputAction m_Player_WallCheck;
    private readonly InputAction m_Player_Move;
    private readonly InputAction m_Player_Look;
    private readonly InputAction m_Player_Sprint;
    private readonly InputAction m_Player_ToggleWalk;
    private readonly InputAction m_Player_Aim;
    private readonly InputAction m_Player_Web;
    ...
    public struct PlayerActions
    {
        ...
        /// <summary>
        /// Provides access to the underlying input action "Player/WallCheck".
        /// </summary>
        public InputAction @WallCheck => m_Wrapper.m_Player_WallCheck;
        /// <summary>
        ...
        /// <summary>
        /// Provides access to the underlying input action "Player/Web".
        /// </summary>
        public InputAction @Web => m_Wrapper.m_Player_Web;
        /// <summary>
        ...
        public void AddCallbacks(IPlayerActions instance)
        {
            ...
            @WallCheck.started += instance.OnWallCheck;
            @WallCheck.performed += instance.OnWallCheck;
            @WallCheck.canceled += instance.OnWallCheck;
    ...
    public interface IPlayerActions
    {
        ...
        /// <summary>
        /// Method invoked when associated input action "WallCheck" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
        /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
        void OnWallCheck(InputAction.CallbackContext context);
        /// <summary>
        ...
        /// <summary>
        /// Method invoked when associated input action "Web" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
        /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
