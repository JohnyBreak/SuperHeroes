...
namespace Synty.AnimationBaseLocomotion.Samples
{
    public class SampleCameraController : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            if (_inputReader == null) _inputReader = _syntyCharacter.GetComponent<InputReader>();
            if(_playerTarget == null) _playerTarget = _syntyCharacter.transform.Find("SyntyPlayer_LookAt");
            if (_lockOnTarget == null) _lockOnTarget = _syntyCharacter.transform.Find("TargetLockOnPos");
